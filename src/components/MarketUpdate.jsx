      ...
      <section id="market" className="market-section">
        <div className="container">
          <div className="market-content">
            <h2>Buy <span>crypto</span> at true cost</h2>
            <h4>Get the latest price of top currencies!</h4>
              ...
              >
                ...
                {data.map((item) => (
                  ...
                  >
                    ...
                    <p>{"Rs. " + numberWithCommas(item.current_price.toFixed(2))}</p>
                    <p
                      className={
                        "slider-coin__price " +
                    ...
                    <p>{"Rs. " + numberWithCommas(item.market_cap)}</p>
                  </Link>
                ))}
              </div>
            </div>
